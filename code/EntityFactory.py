...
class EntityFactory:
    ...
    @staticmethod
    def get_entity(entity_name: str, window=None):
        if entity_name == 'Level1Bg':
            ...
            return Enemy('Enemy1', (WIN_WIDTH + 10, random.randint(40, WIN_HEIGHT - 40)), window)
        elif entity_name == 'Enemy2':
            return Enemy('Enemy2', (WIN_WIDTH + 10, random.randint(40, WIN_HEIGHT - 40)), window)
        elif entity_name == 'Enemy3':
            return Enemy('Enemy3', (WIN_WIDTH + 10, random.randint(40, WIN_HEIGHT - 40)), window)
